...
set out "benchintersection6march2014_v3.pdf"

plot "benchintersection6march2014.txt" using 1:($36/$3) ti "SIMD v3" with linespoints lw 2 ps 0.5,\
"" using 1:($32/$3) ti "Wu SIMD v3" with linespoints lw 2 ps 0.5,\
"" using 1:($33/$3) ti "Wu SIMD v3 aligned" with linespoints lw 2 ps 0.5,\
"" using 1:($34/$3) ti "Wu SIMD v3 cmpeq flagged" with linespoints lw 2 ps 0.5
